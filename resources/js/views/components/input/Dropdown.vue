<template>
    <div :style="style" :class="$props.class">
        ...
        <select :id="name" :value="modelValue" :required="required" @input="onInput" class="block w-full px-3 py-2 placeholder-gray-400 border border-gray-300 rounded-md shadow-sm appearance-none focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-sm">
